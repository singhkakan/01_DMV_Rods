...
cell_type <- c("E8.5", "Ret_E11.5", "Ret_E12.5", "Ret_E14.5", "Ret_E17.5", "Ret_P3", "Ret_P21","Rod3m", "Cones2m","FC_1w", "FC_2w",  "NeuN_pos", "HSC")
...
for (i in length(6)) {
  genic_types[[i]] <- read.delim("GRCm39.ncRNA.bed", 
                          header = FALSE,
                          skip = 1)
ncRNA <- ncRNA[,c(1:4,6)]
colnames(ncRNA) <- c("seqnames", "start", "end", "Gene", "strand")
